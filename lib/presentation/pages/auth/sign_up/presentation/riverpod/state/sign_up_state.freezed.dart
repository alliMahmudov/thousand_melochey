...
mixin _$SignUpState {
  ...
  SignUpResponse? get data => throw _privateConstructorUsedError;
...
class _$SignUpStateImpl implements _SignUpState {
  ...
  @override
  String toString() {
    return 'SignUpState(isLoading: $isLoading, isLogin: $isLogin, isLoginError: $isLoginError, isValid: $isValid, email: $email, errorMessage: $errorMessage, password: $password, id: $id, name: $name, lastName: $lastName, phoneNumber: $phoneNumber, saveMe: $saveMe, data: $data, emailController: $emailController, passwordController: $passwordController)';
  }
...
abstract class _SignUpState implements SignUpState {
  const factory _SignUpState(
      ...
      final SignUpResponse? data,
      final TextEditingController? emailController,
      final TextEditingController? passwordController}) = _$SignUpStateImpl;
